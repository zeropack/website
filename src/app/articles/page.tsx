    ...
    <section className="bg-stone py-14 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-4 max-w-3xl text-lg text-charcoal/75">
          Practical global guides on branded packaging, compostable packaging, ecommerce fulfilment, compliance and artwork.
        </p>
        ...
        <div className="mt-14">
          <h2 className="font-heading text-xl font-semibold text-charcoal">Global packaging articles</h2>
          <p className="mt-2 max-w-2xl text-sm text-charcoal/70">
            Market-neutral guidance. Australia- and UK-specific regulatory or market content lives in the relevant regional article hub.
          </p>
