...
> = {
  ...
  uk: {
    ...
    heroSub:
      "Custom branded mailers made to order for planned ecommerce fulfilment — with TÜV OK compost HOME certification, practical custom-production quantities and design support throughout the process.",
    certificationMetric: "TÜV OK compost HOME",
    certificationLabel: "Independent home-compostability certification",
          ...
          <div className="rounded-2xl border border-white/15 bg-white/5 p-7 backdrop-blur-sm sm:p-10">
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 font-heading text-xl font-semibold text-white">The 2026 Branded &amp; Eco Friendly Packaging Guide</p>
