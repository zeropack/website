...
export const brandGuide: BrandGuide = {
  ...
  sections: [
  {
    ...
    subsections: [
      {
        heading: "Packaging Is Part of the Customer Experience",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Customers Are More Aware of Packaging Waste",
        paragraphs: [
          ...
          "For brands in fashion, beauty, wellness, gifts, and lifestyle categories, this is especially relevant. These audiences tend to care about the brands they buy from. They pay attention to detail. They often share unboxing moments on social media. Packaging that feels lazy, wasteful, or out of step with the product and the brand can quietly undermine the experience the product itself was designed to create. See also: [branded mailers for ecommerce](/articles/branded-mailers-for-ecommerce/) and the [ecommerce mailers guide](/articles/ecommerce-mailers-guide/).",
        ],
      },
      {
        heading: "Plastic Packaging Can Feel Misaligned With Brand Values",
        paragraphs: [
      ...
      {
        heading: "Ecommerce Packaging Is Highly Visible",
        paragraphs: [
      ...
      {
        heading: "Growing Pressure to Make Better Choices",
        paragraphs: [
    ...
    subsections: [
      {
        ...
        paragraphs: [
          ...
          "The word 'compostable' is not interchangeable with 'biodegradable' or 'eco-friendly'. These terms mean different things, and the differences matter. This is covered in detail in Section 10 of this guide. Read more: [compostable vs biodegradable packaging](/articles/compostable-vs-biodegradable-packaging/) and the full [compostable packaging guide](/articles/compostable-packaging-guide/).",
        ],
      },
      {
        heading: "Custom and Branded",
        paragraphs: [
      ...
      {
        heading: "What Custom Compostable Packaging Is Not",
        paragraphs: [
      ...
      {
        heading: "Material Options at a Glance",
        paragraphs: [
        ...
        table: {
          headers: ["Material / Format","Best For","Main Strength","Main Watch-Out"],
          rows: [
            ["Certified compostable film","Mailers, garment bags and selected flexible formats","Can reduce reliance on conventional plastic and support a clearer end-of-life story","Claims must match the exact certification and disposal pathway"],
            ["Recycled plastic mailers","Brands wanting a lower-cost transition from virgin plastic","Reduces demand for virgin plastic","Still plastic at end of life and may not support the same brand message"],
            ["Paper / kraft packaging","Dry, flat, lightweight items","Familiar recycling pathway and natural look","Moisture exposure, coatings and durability can be issues"],
            ["Rigid boxes","Fragile, premium or structured products","Protection and presentation","Higher freight volume and often more material per shipment"],
            ["Plain stock packaging","Very early-stage brands or urgent dispatch needs","Fast and low commitment","Limited brand impact and less differentiated customer experience"],
          ],
          gated: true,
        },
      },
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Why Mailers Are Often the Best First Step",
        paragraphs: [
          ...
          "For these categories, a custom printed compostable mailer gives brands a visible, tangible way to improve the unboxing experience and present their packaging in a way that is consistent with their product quality and values. For the full process, see [how custom compostable mailers work](/articles/how-custom-compostable-mailers-work/) and the [custom compostable mailers guide](/articles/custom-compostable-mailers-guide/).",
        ],
        bullets: [
      ...
      {
        heading: "What Makes Custom Compostable Mailers Effective",
        paragraphs: [
      ...
      },
      {
        ...
        table: {
          headers: ["Product Category","Why Mailers Work Well"],
          rows: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "A. Custom Compostable Shopping Bags",
        paragraphs: [
          ...
          "Best suited for:",
          "Key benefits:",
          "Things to consider: See the [custom compostable packaging guide](/articles/custom-compostable-packaging-guide/) and [compostable mailers guide](/articles/compostable-mailers-guide/) for format-specific detail.",
        ],
        bullets: [
      ...
      {
        heading: "B. Custom Compostable Garment Bags",
        paragraphs: [
      ...
      {
        heading: "C. Custom Compostable Padded Mailers",
        paragraphs: [
      ...
      {
        heading: "D. Compostable Layflat Tubing",
        paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      "Use this table to get an initial sense of which packaging format best suits your business needs. These are general guidelines — the right choice will depend on your specific products, shipping volumes, and brand goals. Compare options in detail: [eco friendly packaging guide](/articles/eco-friendly-packaging-guide/) and [compostable mailers vs recycled plastic mailers](/articles/compostable-mailers-vs-recycled-plastic-mailers/).",
    ],
    table: {
      headers: ["Packaging Type","Best For","Brand Benefit","Operational Consideration","Best Stage of Business"],
      rows: [
        ["Custom compostable mailers","Soft goods, fashion, beauty, wellness, gifts, books","Premium brand presentation, strong unboxing moment","MOQ from ~2,000 units; lead time required","Growing brand shipping regular orders"],
        ["Custom compostable shopping bags","Retail stores, events, boutiques","Visible brand carry, point-of-sale presence","In-store use; not for postal shipping","Retail or event-based businesses"],
        ["Custom compostable garment bags","Fashion brands, apparel fulfilment","Garment protection with brand visibility","Sizing precision required","Fashion brands with consistent garment SKUs"],
        ["Custom compostable padded mailers","Small fragile or semi-fragile products","Protection plus branding","Compostability claims need careful verification","Brands with fragile lightweight goods"],
        ["Compostable layflat tubing","Variable-length products, prints, textiles","Reduces material waste, flexible sizing","Requires sealing equipment","Brands with irregular product lengths"],
        ["Plain packaging with stickers","Early-stage brands testing the market","Low cost, fast setup","Less premium impression","Pre-launch or very early stage"],
        ["Conventional plastic mailers","Any product type","Low cost, widely available","Increasingly misaligned with brand and customer expectations","Not recommended for brand-led businesses"],
        ["Recycled plastic mailers","Any product type","Lower virgin plastic use","Still plastic; limited branding differentiation","Transitional step, not a long-term brand solution"],
        ["Paper / kraft mailers or bags","Lightweight flat items, books, documents","Natural aesthetic; paper recycling pathway","Less durable; moisture exposure risk","Brands with dry, flat, non-fragile products"],
      ],
      gated: true,
    },
    note: "Zero Pack Focus\nZero Pack's primary strength is custom compostable\nmailers. If this is your most relevant format, you are in the right place.\nFor other compostable packaging formats, Zero Pack can help you understand\nwhat options are available and whether they suit your product and business\nrequirements.",
  },
  {
    id: "when-is-the-right-time-to-switch",
    heading: "7. When Is the Right Time to Switch?",
    answerBox: "Switching to custom compostable packaging is not the right move for every business at every stage — use the signals below to assess where you are.",
    paragraphs: [
    ...
    subsections: [
      {
        heading: "Signs You Are Ready",
        paragraphs: [
          "A business may be well-placed to make the switch if most of the following are true: Related: [what MOQ means in custom packaging](/articles/what-moq-means-in-custom-packaging/) and [what to ask before ordering custom packaging](/articles/what-to-ask-before-ordering-custom-packaging/).",
        ],
        bullets: [
      ...
      {
        heading: "Signs You May Not Be Ready Yet",
        paragraphs: [
        ...
        note: "A Helpful Reframe\nNot being ready now is not a permanent state. Many brands\nthat are not yet ready for custom compostable packaging simply need to\nconsolidate their branding, reach a consistent order volume, or clarify their\nproduct range first. If that is where you are, the most useful step is to get\nclear on what needs to happen before custom packaging becomes viable.\nZero Pack is happy to have that conversation. Sometimes\nthe most useful outcome of an initial enquiry is a clear picture of what to\ndo first.",
      },
    ],
  },
  {
    ...
    subsections: [
      {
        ...
        paragraphs: [
          "Packaging is the first physical touchpoint after purchase. A well-designed, branded compostable mailer makes that moment feel considered, professional, and intentional. For businesses that have invested in product quality, branding, and marketing, custom packaging brings the physical experience in line with everything else. See: [branded mailers for ecommerce](/articles/branded-mailers-for-ecommerce/) and [how branded packaging improves customer experience](/articles/how-branded-packaging-improves-customer-experience/).",
        ],
      },
      {
        heading: "Stronger Customer Experience",
        paragraphs: [
      ...
      {
        heading: "Higher Perceived Value",
        paragraphs: [
      ...
      {
        heading: "A Repeat Brand Touchpoint",
        paragraphs: [
      ...
      {
        heading: "Social Media and Unboxing",
        paragraphs: [
      ...
      {
        heading: "Loyalty and Brand Alignment",
        paragraphs: [
      ...
      {
        heading: "Support for Premium Positioning",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Reducing Reliance on Conventional Plastic",
        paragraphs: [
          ...
          "For brands that currently use conventional plastic mailers, switching to certified compostable alternatives can be a genuine and credible improvement. It is not a claim to have solved every packaging challenge, but it can be a practical step in a better direction. Further reading: [eco friendly mailers guide](/articles/eco-friendly-mailers-guide/) and [compostable vs biodegradable packaging](/articles/compostable-vs-biodegradable-packaging/).",
        ],
      },
      {
        heading: "Supporting a Clearer Sustainability Story",
        paragraphs: [
      ...
      {
        heading: "Compostability Depends on Several Factors",
        paragraphs: [
      ...
      {
        heading: "Not All 'Eco' Packaging Claims Are Equal",
        paragraphs: [
        ...
        table: {
          ...
          rows: [
            ["Compostable","Designed to break down into non-toxic components under composting conditions. The key variable is which composting conditions — home or industrial."],
            ["Home compostable","Designed to break down in a domestic compost bin or heap, without requiring industrial processing. Generally, requires more time than industrial composting."],
            ["Industrial compostable","Requires high-temperature industrial composting conditions to break down correctly. Will not break down effectively in a home compost bin or typical soil conditions."],
            ["Biodegradable","Will break down eventually through biological processes — but there is no standard timeframe, no required conditions, and no regulation on this claim in many markets. A very vague term that can mean almost anything and often used in greenwashing."],
            ["Oxo-degradable","Conventional plastic with chemical additives that cause it to fragment into smaller pieces over time. These fragments are still plastic. Oxo-degradable packaging is widely considered a misleading greenwashing environmental claim and is banned in some regions."],
            ["Recyclable","Can be processed through the appropriate recycling waste stream. However, recyclability depends on local infrastructure, consumer behaviour, and contamination. A product being technically recyclable does not guarantee it will be recycled."],
            ["Recycled plastic","Made from post-consumer or post-industrial plastic waste. Still plastic at end of life. A meaningful reduction in virgin plastic use, but not a compostable or zero-waste solution."],
            ["Paper / kraft packaging","Paper-based packaging. Can often be recycled or composted depending on coatings, inks, and laminates. Not inherently plastic-free — some paper packaging has plastic coatings."],
          ],
          gated: true,
        },
      },
  ...
  },
  {
    ...
    answerBox: "Compostable packaging claims are only credible when they are specific, certified, and matched to accurate disposal instructions.",
    paragraphs: [
    ...
    subsections: [
      {
        ...
        paragraphs: [
          ...
          "The most commonly referenced compostability certifications include industrial composting and home composting standards. These vary by region and the specific certification scheme used. When asking about certification for any packaging product, ask for the specific standard the material meets, not just confirmation that it is compostable. Deep dives: [home compostable vs industrial compostable packaging](/articles/home-compostable-vs-industrial-compostable-packaging/), [what is AS5810](/articles/what-is-as5810-home-compostable-certification/), and [how to reduce plastic packaging in ecommerce](/articles/how-to-reduce-plastic-packaging-in-ecommerce/).",
        ],
      },
      {
        heading: "Why 'Biodegradable' Alone Is Not Enough",
        paragraphs: [
      ...
      {
        heading: "Home Compostable vs Industrial Compostable",
        paragraphs: [
      ...
      },
      {
        ...
        note: "What to Ask Your Packaging Supplier\nBefore placing an order, ask:\n• What specific compostability\ncertification does this material carry?\n• Is it home compostable or industrial\ncompostable?\n• What certification standard and\ncertification body applies?\n• What disposal instructions should we\nprovide to customers?\n• Are there regional differences in\ncomposting infrastructure I should be aware of?\nA good supplier will answer these questions directly and\nspecifically.",
      },
      {
        heading: "Certification Standards at a Glance",
        paragraphs: [
        ...
        table: {
          headers: ["Standard / Scheme","Common Use","What It Indicates","Important Note"],
          rows: [
            ["AS5810","Home compostable packaging, commonly referenced in Australia","Tested for home composting conditions","Product-specific; ask for evidence that applies to the exact material"],
            ["AS4736","Industrial compostable packaging in Australia","Designed for industrial composting conditions","Not the same as home compostable"],
            ["EN 13432/TUV OK Compost Industrial","Industrial compostable packaging in Europe/UK contexts","Compostable under defined industrial conditions","Requires appropriate facility access"],
            ["TUV OK compost HOME","Home compostability certification used internationally","Designed for lower-temperature home composting conditions","Check certificate scope and product coverage"],
            ["ASTM D6400 / D6868","Commonly referenced in the United States","Compostability testing for plastics/coated materials","Often linked with BPI certification in market claims"],
            ["Supplier claim only","Unverified marketing language","No independent proof by itself","Treat as a red flag until documentation is provided"],
          ],
          gated: true,
        },
      },
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Why Custom Packaging Has MOQs",
        paragraphs: [
          ...
          "Custom packaging is not the same as buying pre-made stock bags. Every run is made specifically for your brand, your size, and your print requirements. MOQs reflect the minimum quantity at which that production run is commercially viable. Related: [what MOQ means in custom packaging](/articles/what-moq-means-in-custom-packaging/).",
        ],
      },
      {
      ...
      {
        heading: "Why Unit Cost Improves at Higher Volumes",
        paragraphs: [
      ...
      {
        heading: "The Right Way to Think About Packaging Cost",
        paragraphs: [
        ...
        note: "A Better Cost Question\nWhat does this packaging help my brand communicate every\ntime an order arrives?\nA custom compostable mailer is not just a shipping cost.\nIt is a brand touchpoint. It reinforces your visual identity. It improves the\ncustomer experience. It can reduce the gap between how premium your product\nis and how premium your packaging looks. It supports your sustainability story.\nIt can be photographed and shared.\nWhen you account for all of\nthose factors, the difference in unit cost between a generic plastic bag and\na branded compostable mailer looks quite different.",
      },
      {
        heading: "Comparing Packaging Options by Value, Not Just Price",
        table: {
          headers: ["Factor","Conventional Plastic","Recycled Plastic","Custom Compostable"],
          rows: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "What You Need Before Requesting a Quote",
        paragraphs: [
          "Before contacting Zero Pack for a quote, it helps to have the following information ready or at least roughly defined: See: [how to prepare artwork for custom mailers](/articles/how-to-prepare-artwork-for-custom-mailers/) and [what to ask before ordering custom packaging](/articles/what-to-ask-before-ordering-custom-packaging/).",
        ],
        bullets: [
      ...
      {
        heading: "Print Quality and Artwork",
        paragraphs: [
      ...
      {
        heading: "Before You Request a Quote: Checklist",
        table: {
          headers: ["✓","Item"],
          rows: [
            ["","Logo file in vector or high-resolution format"],
            ["","Brand colour codes (Pantone, HEX, or CMYK)"],
            ["","Preferred mailer size or product dimensions"],
            ["","Quantity needed"],
            ["","Estimated print colours"],
            ["","Delivery country confirmed"],
            ["","Product type noted"],
            ["","Artwork ready or design direction described"],
            ["","Required by date identified"],
            ["","3PL requirements checked (if applicable)"],
          ],
          gated: true,
        },
      },
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Custom Packaging Is Not Off-the-Shelf",
        paragraphs: [
          ...
          "For this reason, Zero Pack asks brands to factor lead times into their planning from the start. Confirming the required delivery date early in the quoting conversation is always worthwhile. Related: [how custom compostable mailers work](/articles/how-custom-compostable-mailers-work/).",
        ],
      },
      {
        heading: "Reorder Before You Run Out",
        paragraphs: [
      ...
      {
        heading: "Planning Around Peaks and Launches",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Start With Your Most Common Size",
        paragraphs: [
          ...
          "Measure your most commonly shipped products, add appropriate clearance for folding and closure, and use that as the basis for your first size selection. Related: [how to prepare artwork for custom mailers](/articles/how-to-prepare-artwork-for-custom-mailers/) and the [ecommerce mailers guide](/articles/ecommerce-mailers-guide/).",
        ],
      },
      {
        heading: "Keep the Artwork Clear and Recognisable",
        paragraphs: [
      ...
      {
        heading: "Choose Quantity Based on Realistic Usage",
        paragraphs: [
      ...
      {
        heading: "Think About the Customer Moment",
        paragraphs: [
      ...
      {
        heading: "Include Disposal Guidance",
        paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      "Work through the questions below. Each 'yes' answer scores one point. See also: [what to ask before ordering custom packaging](/articles/what-to-ask-before-ordering-custom-packaging/).",
    ],
    table: {
      headers: ["","Question","Yes / No"],
      rows: [
        ["□","Do you ship at over one hundred orders per month?",""],
        ["□","Can you realistically use 2,000 units or more within two years?",""],
        ["□","Do you have stable, established branding (logo, colours, visual identity)?",""],
        ["□","Do you know your most common packaging size?",""],
        ["□","Do you want packaging to improve brand perception and customer experience?",""],
        ["□","Do you care about your sustainability positioning with customers?",""],
        ["□","Are you ready to plan three to six weeks ahead for production and delivery?",""],
        ["□","Do you want to reduce your reliance on conventional plastic packaging?",""],
        ["□","Do you have, or can you create, print-ready artwork or logo files?",""],
        ["□","Is your product range reasonably consistent in size and weight?",""],
      ],
      gated: true,
    },
    table2: {
      ...
      rows: [
        ["0 – 3","Start with simple improvements. Focus on clarifying your branding, validating order volumes, and confirming product sizing before investing in custom packaging."],
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "Ordering too many sizes at once",
        paragraphs: [
          "Start with one or two sizes that cover the majority of your orders. A wide size range creates inventory complexity and higher reorder thresholds. Consolidate first, expand later. Related: [eco friendly mailers guide](/articles/eco-friendly-mailers-guide/) and [compostable vs biodegradable packaging](/articles/compostable-vs-biodegradable-packaging/).",
        ],
      },
      {
        heading: "Choosing the cheapest option without checking quality",
        paragraphs: [
      ...
      {
        heading: "Using vague compostability claims",
        paragraphs: [
      ...
      {
        heading: "Forgetting disposal instructions",
        paragraphs: [
      ...
      {
        heading: "Not checking artwork requirements before design",
        paragraphs: [
      ...
      {
        heading: "Leaving reorders too late",
        paragraphs: [
      ...
      {
        heading: "Not checking product fit before ordering",
        paragraphs: [
      ...
      {
        heading: "Assuming all compostable packaging is the same",
        paragraphs: [
      ...
      {
        heading: "Choosing packaging that does not match brand positioning",
        paragraphs: [
      ...
      {
        heading: "Treating packaging only as a cost",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      {
        heading: "What Zero Pack Can Help You With",
        paragraphs: [
          "Zero Pack | Custom compostable packaging for brands that care.",
          "www.zeropack.co",
        ],
        bullets: [
          "Choosing the right mailer format and size for your products",
        ...
        note: "Get Started\nVisit www.zeropack.co to request a\ncustom quote.\nIf you are ready to replace plain or plastic-heavy\npackaging with custom compostable mailers made for your brand, Zero Pack can\nhelp you work through the right size, quantity, artwork, and quote.\nYou do not need to have everything figured out before\nreaching out.\nThat is what the quoting conversation is for.",
      },
    ],
  },
],
