...
const coreFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. US delivery details are confirmed during quoting based on your location and order specification.",
  },
  {
...
export const regionConfig: RegionConfig = {
  ...
  shippingNotes: [
    "Delivery timelines are confirmed during quoting for US ecommerce fulfilment needs.",
  ],
  moqNotes:
  ...
  seo: {
    home: {
      title: "Zero Pack US | Custom Compostable Mailers for Ecommerce Brands",
      description:
        "Custom compostable packaging for ecommerce brands shipping across the US. Quote-based, made to order, designed for brand presentation and practical shipping.",
      canonicalPath: "/us/",
    },
    mailers: {
      title: "Custom Compostable Mailers US | Zero Pack",
      description:
        "Create custom branded compostable mailers for your business. Durable, waterproof, made to order and designed for ecommerce brands shipping in the US.",
